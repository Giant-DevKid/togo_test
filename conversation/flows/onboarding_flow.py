...
from conversation.ai.extractors.role_extractor import (
    extract_user_role
)

from conversation.ai.generators.welcome_generator import (
...
# HANDLE ROLE
# =========================================
def handle_role_step(
    session,
    message
):

    role = extract_user_role(
        message
    )
