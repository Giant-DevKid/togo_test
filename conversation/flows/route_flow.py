...
from conversation.ai.extractors.route_extractor import (
    extract_route_data
)
...
def start_route_flow(
    session,
    message
):

    extracted = extract_route_data(
        message
    )

    start_name = extracted.get(
        "start_name"
    )
...
# =========================================
def handle_new_route_destination(
    session,
    message
):
...
# =========================================
def handle_route_delete_selection(
    session,
    message
):
...
# =========================================
def handle_route_delete_confirmation(
    session,
    message
):
